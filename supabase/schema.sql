...
create table if not exists public.user_app_state (
  ...
  settings jsonb not null default '{"hourlyRate":"50","targetHourlyRate":"25","workdayHours":"8","requireProjectForFixed":false}'::jsonb,
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now()
);

alter table public.user_app_state
add column if not exists settings jsonb not null default '{"hourlyRate":"50","targetHourlyRate":"25","workdayHours":"8","requireProjectForFixed":false}'::jsonb;
