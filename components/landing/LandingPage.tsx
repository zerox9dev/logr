...
export type SiteLang = "en" | "ru" | "uk" | "pl" | "de";
...
const LANDING_COPY = {
  ...
  pl: {
    nav: { preview: "Podgląd", features: "Funkcje", pricing: "Cennik", tryFree: "Wypróbuj za darmo" },
    hero: {
      eyebrow: "Tracker czasu dla freelancerów",
      line1: "Twój czas",
      line2: "to twoja",
      line3: "waluta.",
      sub: "Każda niezafakturowana minuta to pieniądze zostawione na stole. Logr sprawia, że każda sekunda jest widoczna — abyś zawsze otrzymywał zapłatę, na jaką zasługujesz.",
      start: "Zacznij śledzić za darmo",
      see: "Zobacz w akcji",
      now: "TWÓJ CZAS, WŁAŚNIE TERAZ",
      workingOn: "Pracuję nad",
      project: "Przeprojektowanie strony głównej",
      caption1: "W filmie widać było, jak czas się kończy.",
      caption2: "Z Logr widzisz, jak się mnoży.",
    },
    ticker: [
      "CZAS TO PIENIĄDZ",
      "KAŻDA MINUTA SIĘ LICZY",
      "LOGUJ - FAKTURUJ - ZARABIAJ",
    ...
    impact: [
      {
        big: "2,5h",
        suffix: "/tydz",
        desc: "Tyle czasu freelancerzy tracą na administrację - ręczne pisanie faktur, wypełnianie arkuszy, ",
        strong: "gonią za godzinami, które zapomnieli zalogować.",
      },
      {
        desc: "Stracone rocznie przy stawce $50/h z tych 2,5 godziny. To ",
        strong: "prawdziwe pieniądze, na które pracowałeś",
        tail: " - i których nie dostałeś.",
      },
      {
        big: "1",
        suffix: "aplikacja",
        desc: "Wystarczy, by to naprawić. Śledzenie czasu, klienci, zadania, faktury. ",
        strong: "Wszystko w jednym miejscu.",
      },
    ],
    preview: {
      title1: "Aplikacja.",
      title2: "Czysty design.",
      sub: "Bez onboardingu, bez tutoriali. Dodaj klienta, wpisz zadanie, wciśnij Spację. To wszystko.",
    },
    features: {
      label: "Funkcje",
      title1: "Zbudowane pod sposób, w jaki freelancerzy",
      title2: "naprawdę pracują.",
      c1t1: "Spacja do",
      c1t2: "startu",
      c1d: "Wciśnij Spację, aby rozpocząć śledzenie. Wciśnij Spację, aby zatrzymać. Najszybszy tracker to ten, który nie przeszkadza.",
      c2t1: "Klienci",
      c2t2: "i projekty",
      c2d: "Organizuj pracę według klientów i projektów. Od razu widać, ile zarabiasz na każdej współpracy.",
      c3t1: "Notatki",
      c3t2: "do sesji",
      c3d: "Dodaj linię opisującą co zrobiłeś. Pojawia się na fakturze - klient płaci bez pytań.",
      c4t1: "Faktura",
      c4t2: "jednym kliknięciem",
      c4d: "Filtruj według klienta i miesiąca, kliknij PDF. Profesjonalna faktura gotowa w mniej niż 60 sekund.",
    },
    pricing: {
      label: "Cennik",
      title1: "Prosto.",
      title2: "Bez niespodzianek.",
      ...
      upToClients: "Do 3 klientów",
      unlimitedClients: "Nieograniczona liczba klientów",
      invoicePdf: "Faktury PDF",
      csvExport: "Eksport CSV",
      cloudSync: "Synchronizacja w chmurze",
      multiDevice: "Wiele urządzeń",
    },
    cta: {
      title1: "Przestań tracić czas.",
      title2: "Zacznij zarabiać więcej.",
      tryFree: "Wypróbuj Logr za darmo",
      seeApp: "Zobacz aplikację",
    },
    footer: {
      copy: "© 2026 Logr. Zbudowane dla freelancerów.",
      app: "Aplikacja",
      pricing: "Cennik",
      privacy: "Prywatność",
    },
  ...
  de: {
    nav: { preview: "Vorschau", features: "Funktionen", pricing: "Preise", tryFree: "Kostenlos starten" },
    hero: {
      eyebrow: "Zeiterfassung für Freelancer",
      line1: "Deine Zeit",
      line2: "ist deine",
      line3: "Währung.",
      sub: "Jede nicht abgerechnete Minute ist Geld, das auf dem Tisch liegenbleibt. Logr macht jede Sekunde sichtbar — damit du immer das bekommst, was deine Arbeit wert ist.",
      start: "Kostenlos starten",
      see: "In Aktion sehen",
      now: "DEINE ZEIT, GERADE JETZT",
      workingOn: "Gerade in Arbeit",
      project: "Homepage-Redesign",
      caption1: "Im Film konnte man sehen, wie die Zeit ablief.",
      caption2: "Mit Logr siehst du, wie sie sich summiert.",
    },
    ticker: [
      "ZEIT IST GELD",
      "JEDE MINUTE ZÄHLT",
      "ERFASSEN - ABRECHNEN - VERDIENEN",
    ...
    impact: [
      {
        big: "2,5h",
        suffix: "/Woche",
        desc: "Verlieren Freelancer im Schnitt für Verwaltung - Rechnungen von Hand schreiben, Tabellen ausfüllen, ",
        strong: "Stunden nachjagen, die sie vergessen haben zu erfassen.",
      },
      {
        desc: "Verlust pro Jahr bei $50/h durch diese 2,5 Stunden. Das ist ",
        strong: "echtes Geld, das du dir verdient hast",
        tail: " - und nie bekommen hast.",
      },
      {
        big: "1",
        suffix: "App",
        desc: "Reicht aus, um das zu ändern. Zeiterfassung, Kunden, Aufgaben, Rechnungen. ",
        strong: "Alles an einem Ort.",
      },
    ],
    preview: {
      title1: "Die App.",
      title2: "Klar im Design.",
      sub: "Kein Onboarding, keine Tutorials. Kunden hinzufügen, Aufgabe tippen, Leertaste drücken. Das war's.",
    },
    features: {
      label: "Funktionen",
      title1: "Entwickelt für die Art, wie Freelancer",
      title2: "wirklich arbeiten.",
      c1t1: "Leertaste zum",
      c1t2: "Starten",
      c1d: "Leertaste drücken zum Starten. Leertaste drücken zum Stoppen. Der schnellste Tracker ist der, der nicht im Weg steht.",
      c2t1: "Kunden",
      c2t2: "& Projekte",
      c2d: "Arbeit nach Kunden und Projekten organisieren. Sieh sofort, wie viel jede Zusammenarbeit einbringt.",
      c3t1: "Sitzungs-",
      c3t2: "notizen",
      c3d: "Füge eine Zeile hinzu, was du gemacht hast. Sie erscheint auf der Rechnung - Kunden zahlen ohne Rückfragen.",
      c4t1: "Rechnung",
      c4t2: "auf Knopfdruck",
      c4d: "Nach Kunde und Monat filtern, auf PDF klicken. Eine professionelle Rechnung in unter 60 Sekunden.",
    },
    pricing: {
      label: "Preise",
      title1: "Einfach.",
      ...
      unlimitedTracking: "Unbegrenzte Zeiterfassung",
      upToClients: "Bis zu 3 Kunden",
      unlimitedClients: "Unbegrenzte Kunden",
    ...
    cta: {
      title1: "Hör auf, Zeit zu verlieren.",
      title2: "Fang an, mehr zu verdienen.",
      tryFree: "Logr kostenlos testen",
      seeApp: "App ansehen",
    },
    footer: {
      copy: "© 2026 Logr. Gebaut für Freelancer.",
      app: "App",
      pricing: "Preise",
      privacy: "Datenschutz",
    },
