export default function WelcomeState({ theme }) {
  return (
    <div style={{ marginTop: 60, maxWidth: 360 }}>
      <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 36, color: theme.timerColor, letterSpacing: "0.05em", marginBottom: 12 }}>
        WELCOME TO LOGR
      </div>
      ...
      {[
        ...
        <div key={n} style={{ display: "flex", gap: 16, marginBottom: 20, alignItems: "flex-start" }}>
          <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 24, color: theme.faint, minWidth: 20 }}>{n}</div>
          <div>
